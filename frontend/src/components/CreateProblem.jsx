    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2 text-left" htmlFor="problemName">
              Problem Name
            </label>
            <input
              id="problemName"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2 text-left" htmlFor="problemStatement">
              Problem Statement
            </label>
            <textarea
              id="problemStatement"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2 text-left" htmlFor="difficulty">
              Difficulty
            </label>
            <select
              id="difficulty"
